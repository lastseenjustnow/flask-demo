...
def generate_bond_parameters():
    ...
    requests.post(
        "http://airflow:8080/api/experimental/dags/bbg_bonds/dag_runs", data=json.dumps(data))
...
def reco_fcstone_trade_price_trnfhr():
    ...
    requests.post("http://airflow:8080/api/experimental/dags/fcstone_trnfhr/dag_runs",
...
def reco_fcstone_trade_price_st4f1():
    ...
    requests.post("http://airflow:8080/api/experimental/dags/fcstone_st4f1/dag_runs",
                  data=json.dumps(data))
    res = ResultsTable(
        [ResultInfo("Command has been passed to a server. File will have been delivered to email in a few minutes.")])
    return render_template('results.html', table=res)
...
def reco_fcstone_settlement_prices():
    ...
    requests.post("http://airflow:8080/api/experimental/dags/reco_fcstone_settlement_prices/dag_runs",
                  data=json.dumps(data))
    res = ResultsTable(
        [ResultInfo("Command has been passed to a server. File will have been delivered to email in a few minutes.")])
    return render_template('results.html', table=res)
...
def reco_kgi_trade_price():
    ...
    requests.post("http://airflow:8080/api/experimental/dags/kgi_trade_price/dag_runs",
                  data=json.dumps(data))
    res = ResultsTable(
        [ResultInfo("Command has been passed to a server. File will have been delivered to email in a few minutes.")])
    return render_template('results.html', table=res)

@app.route('/hgnh_trade_price', methods=['GET', 'POST'])
def reco_hgnh_trade_price():
    data = {"conf": {"to_date": request.form['hgnh_trade_price']}}
    requests.post("http://airflow:8080/api/experimental/dags/reco_hgnh_trade_price/dag_runs",
                  data=json.dumps(data))
    res = ResultsTable(
        [ResultInfo("Command has been passed to a server. File will have been delivered to email in a few minutes.")])
    return render_template('results.html', table=res)
...
def reco_client_broker():
    ...
    requests.post("http://airflow:8080/api/experimental/dags/reco_client_broker/dag_runs",
                  data=json.dumps(data))
    res = ResultsTable(
        [ResultInfo("Command has been passed to a server. File will have been delivered to email in a few minutes.")])
    return render_template('results.html', table=res)
